...
const routes = ["Home", "Link Student","Curriculum", "Inquiry", "Memberships", "Awards", "Events", "Retail", "Class Reservation", "Reserved Classes", "Class Check In", "Payment Methods", "Purchase History"];
