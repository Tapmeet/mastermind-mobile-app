...
import { View, Image, StyleSheet, ImageBackground, ActivityIndicator, TouchableOpacity, Text } from "react-native";
           ...
           <View>
            <View>
             ...
             <View style={[loginStyle.bodyContainer, { marginTop: 20 }]}>
               <Text style={globalStyle.h3}>Enter Verification Code </Text>
            ...
            <View style={verificationStyle.spaceBetween}>
              <OtpInputss navigation={props.navigation} getOtp={(otp) => getOtp(otp)} />
            </View>
